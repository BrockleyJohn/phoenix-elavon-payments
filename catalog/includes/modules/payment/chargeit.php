...
* @version 1.2
*
* @revised 7/23/2015 - Malcolm Spann
...
//      $data .= $key . '=' . urlencode(ereg_replace(',', '', $value)) . '&';
  ...
  function keys() {
    return array('MODULE_PAYMENT_CHARGEIT_STATUS', 
                 'MODULE_PAYMENT_CHARGEIT_ACCOUNT_ID', 
                 'MODULE_PAYMENT_CHARGEIT_USER_ID', 
                 ...
                 'MODULE_PAYMENT_CHARGEIT_ADMIN_EMAIL', 
                 'MODULE_PAYMENT_CHARGEIT_CC_ACCEPTED', 
                 'MODULE_PAYMENT_CHARGEIT_CVV_REQUIRED', 
                 'MODULE_PAYMENT_CHARGEIT_DCC', 
                 'MODULE_PAYMENT_CHARGEIT_DECLINE_HELP');
  }
