...
// lets start with the email confirmation
  ...
  $email_order  = EMAIL_TEXT_1 . $order->customer['firstname'] . ' ' . $order->customer['lastname'] . ',' . "\n\n";
  $email_order .= EMAIL_TEXT_2 . "\n\n" ;

  if(!tep_session_is_registered('customer_is_guest')) {        
    $email_order .= EMAIL_TEXT_3 . ' ' . tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $insert_id, 'SSL', false) . "\n\n" ;
  }
...
// Add for Vertual Merchant - 7-21-15
  tep_session_unregister('payment_error_return');



// MOD: BOF - SmartSuggest BEGIN --- Added 10-08-14
